...
public class OutputPortReverseProvisionTest {
    ...
    public void testGetters() {
        ...
        Spec<DatabricksOutputPortSpecific> spec = new Spec<>();
        ...
        CatalogInfo<DatabricksOutputPortSpecific> catalogInfo = new CatalogInfo<>();
        catalogInfo.setApiVersion("setApiVersion");
        catalogInfo.setKind("setKind");
        catalogInfo.setMetadata("setMetadata");
        catalogInfo.setSpec(spec);

        assertEquals("setApiVersion", catalogInfo.getApiVersion());
        assertEquals("setKind", catalogInfo.getKind());
        assertEquals("setMetadata", catalogInfo.getMetadata());
    ...
    public void testReverseProvisionOutputPort_Success() {
        ...
        ReverseProvisioningStatus status = outputPortReverseProvision.reverseProvision(request);
