...
public class SchedulingSpecificTest {
    ...
    private DatabricksJobWorkloadSpecific.SchedulingSpecific schedulingSpecific;

    @BeforeEach
    public void setUp() {
        schedulingSpecific = new DatabricksJobWorkloadSpecific.SchedulingSpecific();
    }
    ...
    public void testEnableSchedulingNotNullWithValidValue() {
        ...
        Set<ConstraintViolation<DatabricksJobWorkloadSpecific.SchedulingSpecific>> violations =
                validator.validate(schedulingSpecific);
